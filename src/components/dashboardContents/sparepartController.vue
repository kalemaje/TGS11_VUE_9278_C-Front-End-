        ...
        <v-card-text>
            <v-container>
                <v-row>
                    ...
                    <v-col cols="12">
                        <v-select :items="items" v-model="form.merk" label="Dropdown Merk "></v-select>
                    </v-col>
                    <v-col cols="12">
                        <v-text-field label="amount" v-model="form.amount" type="numeric" required></v-text-field>
                    </v-col>
                    <v-col cols="12">
...
export default {
    ...
    methods:{
        ...
        updateData(){
            this.sparepart.append('name', this.form.name);
            this.sparepart.append('email', this.form.email);
            this.sparepart.append('password', this.form.password);
